...
#SBATCH --output=/home/sviswasam/dr/unitree_rl_gym/logs/output_custom.log
#SBATCH --error=/home/sviswasam/dr/unitree_rl_gym/logs/err_custom.err
...
# 7. Execute
python -m legged_gym.scripts.train --task=g1 \
    --num_envs=512 \
    --run_name=g1_custom_architecture \
    --headless 2>&1 | tee train.log