...
#SBATCH --output=/home/sviswasam/dr/unitree_rl_gym/logs/output_video.log
#SBATCH --error=/home/sviswasam/dr/unitree_rl_gym/logs/err_video.err
...
# 7. Execute
 python deploy/deploy_mujoco/record_traj.py g1.yaml